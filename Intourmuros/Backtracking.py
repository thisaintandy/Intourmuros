...
def tsp_backtracking(locations, selected_starting_point, selected_places):
    places = [selected_starting_point] + selected_places
    min_distance = float('inf')
    best_path = None

    def backtrack(path, unvisited):
        ...
        if not unvisited:
            ...
            for i in range(len(unvisited)):
                ...
                backtrack(path, unvisited)
                unvisited.insert(i, next_place)
                path.pop()

    backtrack([selected_starting_point], selected_places)
...
def calculate_path():
    ...
    path = tsp_backtracking(locations, selected_starting_point, selected_places)  # call the tsp function
