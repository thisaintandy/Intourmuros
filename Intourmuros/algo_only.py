...
def show_map():
    ...
    map_widget = map_widget = tkintermapview.TkinterMapView(My_Window, width=423, height=867, corner_radius=0)
    map_widget.set_position(14.5896, 120.9747)
...
def calculate_path():
    ...
    # Finish button
    button_next= Button(My_Window, text="Show Map", font=('Arial', 13, 'bold'), bg="#202020", activebackground="black",
                            fg="white", activeforeground="#3699F2", width=16, height=2, bd=0, borderwidth=0, relief=FLAT, command=lambda:show_map())
