...
def tsp_brute_force(locations, selected_starting_point, selected_places):
    # Add the selected starting point to the list of places
    ...
    def permute(path, unvisited):
        ...
        if not unvisited:
            ...
            for i in range(len(unvisited)):
                ...
                permute(path + [next_place], unvisited[:i] + unvisited[i + 1:])

    permute([selected_starting_point], selected_places)
...
def calculate_path():
    ...
    path = tsp_brute_force(locations, selected_starting_point, selected_places)  # call the tsp function
